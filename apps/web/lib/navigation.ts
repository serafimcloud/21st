...
const marketing: NavigationItem[] = [
  ...
  { title: "Borders", href: "/s/border", demoId: 1135, demosCount: 8 },
  {
  ...
  { title: "Clients", href: "/s/clients", demoId: 981, demosCount: 12 },
  ...
  { title: "Footers", href: "/s/footer", demoId: 1520, demosCount: 12 },
  { title: "Heroes", href: "/s/hero", demoId: 1526, demosCount: 65 },
  { title: "Hooks", href: "/s/hook", demoId: 915, demosCount: 30 },
  { title: "Images", href: "/s/image", demoId: 1018, demosCount: 20 },
...
const ui: NavigationItem[] = [
  { title: "Accordions", href: "/s/accordion", demoId: 1517, demosCount: 35 },
  {
    title: "AI Chats",
    href: "/s/ai-chat",
    isNew: true,
  ...
  { title: "Alerts", href: "/s/alert", demoId: 341, demosCount: 21 },
  { title: "Avatars", href: "/s/avatar", demoId: 791, demosCount: 14 },
  { title: "Badges", href: "/s/badge", demoId: 513, demosCount: 20 },
  { title: "Buttons", href: "/s/button", demoId: 1346, demosCount: 112 },
  {
    title: "Calendars",
    href: "/s/calendar",
    isNew: true,
  ...
  { title: "Cards", href: "/s/card", demoId: 858, demosCount: 72 },
  { title: "Carousels", href: "/s/carousel", demoId: 1247, demosCount: 10 },
  { title: "Checkboxes", href: "/s/checkbox", demoId: 90, demosCount: 15 },
  {
    title: "Date Pickers",
    href: "/s/date-picker",
    isNew: true,
  ...
  { title: "Dropdowns", href: "/s/dropdown", demoId: 390, demosCount: 20 },
  {
    title: "Empty States",
    href: "/s/empty-state",
    demoId: 1435,
  ...
  { title: "Icons", href: "/s/icons", demoId: 865, demosCount: 6 },
  { title: "Inputs", href: "/s/input", demoId: 1456, demosCount: 90 },
  { title: "Links", href: "/s/link", demoId: 1287, demosCount: 13 },
  { title: "Menus", href: "/s/menu", demoId: 1428, demosCount: 13 },
  {
    title: "Notifications",
    href: "/s/notification",
    isNew: true,
  ...
  { title: "Paginations", href: "/s/pagination", demoId: 453, demosCount: 14 },
  {
    title: "Popovers",
    href: "/s/popover",
    isNew: true,
  ...
  { title: "Sliders", href: "/s/slider", demoId: 329, demosCount: 35 },
  {
  ...
  { title: "Tabs", href: "/s/tabs", demoId: 635, demosCount: 32 },
  { title: "Text Areas", href: "/s/textarea", demoId: 190, demosCount: 20 },
