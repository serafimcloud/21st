          ...
          return (
            ...
            >
              <div className="relative">
                ...
                <div className="relative flex h-14 w-14 items-center justify-center rounded-xl bg-white/10 text-white backdrop-blur-sm group-hover:bg-white/15 transition-colors duration-300">
